...
- If `--handoff` in target: output ORCHESTRATE HANDOFF block (see below)
...
Pipeline mode for orchestrator. Runs full workflow, outputs ORCHESTRATE HANDOFF block.
