...
| Processing | /extract, /connect, /update, /verify, /orchestrate, /pipeline |
| Linking | /connect, /update |
| Navigation | /connect (MOC update logic) |
| Schema | /validate, /verify |
| Automation | /orchestrate, /pipeline (chaining mode) |
| Maintenance | /health |
...
| parallel_workers | Update /orchestrate to serial-only mode | Verify tmux available, update /orchestrate for parallel mode |
