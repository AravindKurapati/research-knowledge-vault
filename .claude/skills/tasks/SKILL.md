...
| Pipeline queue | Automated processing state — what the SYSTEM needs to process | Pipeline skills | Automatic: /extract, /orchestrate, /connect |
...
| Pipeline has pending tasks | "Pipeline has {N} pending tasks. Run /orchestrate to process them." |
...
| Read by | /next (priority #1) | /orchestrate (phase routing) |
